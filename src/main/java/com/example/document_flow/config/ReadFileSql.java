...
public class ReadFileSql {
    ...
    /**
     * Реализация функционального интерфейс для сортировки файлов по версии файла указанный в наименования после буквы "V".
    ...
    /**
     * Реализация функционального интерфейс, где
