    ...
    getOutgoingById(idOutgoing).then((outgoing) => {
        ...
        <div class="tab-pane fade" id="${idTab}">
          <div class="btn-group" role="group" aria-label="Basic example">
                <button onclick="fillModelDeleteObject(${outgoing.id},'${idTab}','${idButtonTab}','${textModal}',closeTabOutgoing)" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                        Удалить
                 </button>
             </div>   
              <form>
